[![Build Status](https://travis-ci.org/DrKimpatrick/Carpool_Backend_API.svg?branch=master)](https://travis-ci.org/DrKimpatrick/Carpool_Backend_API)
[![Coverage Status](https://coveralls.io/repos/github/DrKimpatrick/Carpool_Backend_API/badge.svg?branch=master)](https://coveralls.io/github/DrKimpatrick/Carpool_Backend_API?branch=master)
[![Maintainability](https://api.codeclimate.com/v1/badges/589baf6eb6c9145a5fc7/maintainability)](https://codeclimate.com/github/DrKimpatrick/Carpool_Backend_API/maintainability)
